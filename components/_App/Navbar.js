...
const Navbar = () => {
  ...
  const classOne = collapsed ? 'collapse navbar-collapse navbar-container' : 'collapse navbar-collapse show navbar-container';
                ...
                <ul className="navbar-nav">
                  ...
                  <li className="nav-item">
                    <Link href="#" activeClassName="active">
                      <a onClick={(e) => null} className="nav-link">
                        Services
                    ...
                    <ul className="dropdown-menu">
                      <li className="nav-item">
                        <Link href="/musicvideos" activeClassName="active">
                          <a onClick={toggleNavbar} className="nav-link">Music Videos</a>
                        </Link>
                      </li>
                      <li className="nav-item">
                        <Link href="/weddings" activeClassName="active">
                      ...
                      <li className="nav-item">
                        <Link href="/realestate" activeClassName="active">
                          <a onClick={toggleNavbar} className="nav-link">Real Estate</a>
                        </Link>
                      </li>
                      <li className="nav-item">
                        <Link href="/social" activeClassName="active">
